...
FIELD_MAPS: Dict[str, Dict[str, str]] = {
    ...
    "life": {
        "final_expense_carrier": "Insurance carrier name",
        "fe_product_name": "Product or plan name",
        "fe_product_type": "Product type (Whole Life, Term, Final Expense, Graded)",
        "fe_coverage_amount": "Coverage/face amount — number only",
        "fe_beneficiary": "Primary beneficiary name",
        "fe_policy_number": "Policy number",
        "fe_client_premium": "Monthly premium — number only",
