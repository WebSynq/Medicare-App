...
/**
 * Shared commission panels. /commissions section pages (Overview /
 * Statements / Leaderboard) compose these. The /commissions/calculator
 * sub-page uses CommissionCalculator from ./calculator.tsx instead.
 */
